...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
    return (
        <div>
            <article className='w-full flex items-center justify-between rounded-br-2xl rounded-3xl border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl p-12 relative mt-12 lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'>
                ...
                <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                    ...
                    <div className='mt-2 flex items-center'>
                        ...
                        <Link href={link} target='_blank' className='ml-4 rounded-lg bg-dark text-light dark:bg-light dark:text-dark dark:hover:bg-dark dark:hover:text-light p-2 px-6 text-lg font-semibold sm:px-4 sm:text-base'>
                            Visit Project
                        </Link>
                    </div>
                </div>
