...
const about = () => {
    return (
        <>
            <Head>
                <title>Shehab Taher | About Page</title>
                ...
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                            ...
                            <p className='font-medium'>Hi, I am Shehab Taher, a web developer and MERN Stack Web developer with a passion for creating beautiful, functional,
                            ...
                            <p className='font-medium'>Whether I am working on a website, I bring my commitment to design excellence and user-centered thinking to
                        ...
                        <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light dark:bg-dark dark:border-light p-8 xl:col-span-4 md:order-1 md:col-span-8'>
                            ...
                            <Image src={profilePic} alt="shehabTaher" className="w-full h-auto rounded-2xl" priority sizes='(max-width: 768px) 100vw, (max-width: 1200px) 50vw , 33vw' />
                        </div>
